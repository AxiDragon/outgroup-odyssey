const SolutionSection = () => {
	return (
		<div>
			...
			<p><sub>Graphic where you can click on the image, progressing slowly making the resulting group.</sub></p>
			<p>...try to make the mental ingroup you're in, contain the outgroup too!</p>
			<p><i>I should put a better ending here. but I'm not sure what exactly.</i></p>
		</div>
	);
}
